...
class CornersProblem(search.SearchProblem): #Q4
    """
...
def cornersHeuristic(state, problem): #Q5
    """
...
def foodHeuristic(state, problem): #! QUESTAO 6
    """
...
class ClosestDotSearchAgent(SearchAgent): #Q7
